                 ...
                 # **** price range and minimum of all the products selling to UIA company ****
          ...
          maxi.statement <- c('The minimum price from the products sold to the UIA Company is' , findmax)
          print(maxi.statement)
          
          
          # **** price range and minimum of all the products selling to Five Star Auto company ****
          ...
          conv <- as.numeric(rangedata)
          findmax <- min(conv , na.rm = TRUE)
          maxi.statement <- c('The minimum price from the products sold to Five Star Auto Company is' , findmax)
          print(maxi.statement)
          
          
          
          # **** price range and minimum of all the products selling to hafiz  Auto company ****
          ...
          conv <- as.numeric(rangedata)
          findmax <- min(conv , na.rm = TRUE)
          maxi.statement <- c('The minimum price from the products sold to Hafiz Auto Company is' , findmax)
          print(maxi.statement)  
          
          
          # **** price range and minimum of all the products selling to Mega Hi tech Auto company ****
          ...
          conv <- as.numeric(rangedata)
          findmax <- min(conv , na.rm = TRUE)
          maxi.statement <- c('The minimum price from the products sold to Mega Hi-Tech Company is' , findmax)
          print(maxi.statement)
          
          
          # **** price range and minimum of all the products selling to Techno Call company ****
          ...
          conv <- as.numeric(rangedata)
          findmax <- min(conv , na.rm = TRUE)
          maxi.statement <- c('The minimum price from the products sold to Techno Call Company is' , findmax)
          print(maxi.statement)
