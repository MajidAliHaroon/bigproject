            ...
            # **** Order range and max of all the products selling to UIA company ****
            ...
            maxi.statement <- c('The maximum quantity order from the products sold to the UIA Company is' , findmax)
            ...
            conv <- as.numeric(rangedata)
            findmax <- max(conv , na.rm = TRUE)
            maxi.statement <- c('The maximum quantity order from the products sold to Five Star Auto Company is' , findmax)
            print(maxi.statement)
            ...
            conv <- as.numeric(rangedata)
            findmax <- max(conv , na.rm = TRUE)
            maxi.statement <- c('The maximum quantity order from the products sold to Hafiz Auto Company is' , findmax)
            print(maxi.statement)  
            ...
            conv <- as.numeric(rangedata)
            findmax <- max(conv , na.rm = TRUE)
            maxi.statement <- c('The maximum quantity order from the products sold to Mega Hi-Tech Company is' , findmax)
            print(maxi.statement)
            ...
            conv <- as.numeric(rangedata)
            findmax <- max(conv , na.rm = TRUE)
            maxi.statement <- c('The maximum quantity order from the products sold to Techno Call Company is' , findmax)
            print(maxi.statement)
